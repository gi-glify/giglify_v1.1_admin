...
export type Submission = { id: string; user_id: string; task_id: string; worker_name: string; task_name: string; task_code: string | null; status: string; grading_status: string; grading_percentage: number | null; grading_decision: string | null; grading_confidence: number | null; grading_feedback: Record<string, unknown> | null; graded_at: string | null; reward_approved: number | null; reward_paid: number | null; started_at: string; completed_at: string | null };
